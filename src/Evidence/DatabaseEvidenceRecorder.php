...
final readonly class DatabaseEvidenceRecorder implements DurableEvidenceRecorder, EvidenceRecorder
{
    ...
    public function recordRelease(ContextReleaseEvidence $evidence): void
    {
        ...
        $this->insert($this->table, [
            ...
            'review_request_fingerprint' => null,
            'review_outcome' => null,
            'approval_phase' => null,
    ...
    private static function evidenceColumns(): array
    {
        return [
            ...
            'argument_fingerprint', 'idempotency_key_fingerprint', 'approval_receipt_fingerprint', 'review_request_fingerprint', 'review_outcome', 'approval_phase',
