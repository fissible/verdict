...
use Fissible\Verdict\Console\Commands\VerifyEvidenceCommand;
...
final class VerdictServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $approvalMigration = [
            ...
            __DIR__.'/../database/migrations/create_verdict_binding_admission_locks_table.php.stub' => database_path('migrations/2026_09_24_000022_create_verdict_binding_admission_locks_table.php'),
            __DIR__.'/../database/migrations/add_scheme_to_verdict_consumed_binding_guards_table.php.stub' => database_path('migrations/2026_09_25_000023_add_scheme_to_verdict_consumed_binding_guards_table.php'),
        ];
        $reviewMigration = [
