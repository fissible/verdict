...
| [#297](https://github.com/fissible/verdict/issues/297) `RequireReview` substrate (the keystone) | L–XL | none | open — `scope: ready`; substrate build underway, dependency-ordered: ADR 0035 (#428), the loud reserve (#429), the value layer (#434), the review-request store (#439), and the fail-closed decision authorizer have landed; the status reader, database store, and execution gate remain |
